...
public class AccelerometerCommand extends Command {
	...
	// This method waits until the robot stops turning and then returns
	// 'initAngle'
	...
	/*
	 * Updates 'currentAngle'until the robot moves straight or stops then
	 * returns the value public double getCurrAngle(){ while(accel.getX() == 0){
	 * currentAngle = Robot.hardware.gyro.getAngle(); //new rotated angle =
	 * getAngle - current angle } return currentAngle; }
	 */
	...
	/*
	 * public double getInitAngle(){ return Robot.hardware.gyro.getAngle();
	 * 
	 * }
	 */
